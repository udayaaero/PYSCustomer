...
public class COMPLETED1 extends Fragment{
    ...
    private void firstLoadData() {
        ...
        String URL = Constant.APIONE+"/slot/getCourseAndMembrShipBookingHistory?type=MEM&offset=0&limit=5&status=completed";
        itShouldLoadMore = false;

        StringRequest request1 = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("fwfewrfrew1", String.valueOf(response));
    ...
    private void loadMore() {
        ...
        String URL = Constant.APIONE+"/slot/getCourseAndMembrShipBookingHistory?type=MEM&offset="+String.valueOf(mOffset)+"&limit="+String.valueOf(mLimit)+"&status=completed";
