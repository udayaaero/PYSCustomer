...
public class CourseBookingHistoryModel {
    ...
    public CourseBookingHistoryModel(String bookingStatus, String bookingType, String bookedforDate, String bookingtimeStamp,
                                     Integer bookingId, Integer personCount, Double amount, String subActivityType, String vendorName,
                                     String slotReccurence, String courseStartDate, String courseEndDate, String slotStartTime,
                                     String slotEndTime) {
    ...
    public CourseBookingHistoryModel(String bookingStatus, String bookingType, String bookedforDate, String bookingtimeStamp, Integer bookingId, Integer personCount, Double amount, String subActivityType, String vendorName, String slotReccurence, String courseStartDate, String courseEndDate, String slotStartTime, String slotEndTime, String otp) {
        this.bookingStatus = bookingStatus;
        this.bookingType = bookingType;
        this.bookedforDate = bookedforDate;
        this.bookingtimeStamp = bookingtimeStamp;
