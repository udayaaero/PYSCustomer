...
import com.coeuz.pyscustomer.AdapterClass.CourseBookingHistoryAdapter;
...
public class NEARING2 extends Fragment{
    ...
    private CourseBookingHistoryAdapter recyclerAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        recyclerAdapter = new CourseBookingHistoryAdapter(getActivity(),recyclerModels);
    ...
    private void firstLoadData() {
        ...
        String URL = Constant.APIONE+"/slot/getCourseAndMembrShipBookingHistory?type=COR&offset=0&limit=5&status=nearing";
        itShouldLoadMore = false;

        StringRequest request1 = new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                Log.d("cdsdsfeww", String.valueOf(response));
                        ...
                        for(int i=0;i<jsonArray.length();i++){
                           ...
                           // String slotStatus=jsonObject.getString("slotStatus");
                               ...
                               String otp = jsonObject.getString("otp");
                                ...
                                Log.d("jgiotjiort1",bookingStatus);
                                Log.d("jgiotjiort2",bookingType);
                                Log.d("jgiotjiort3",bookedforDate);
                                Log.d("jgiotjiort4",bookingtimeStamp);
                                Log.d("jgiotjiort5", String.valueOf(bookingId));
                                Log.d("jgiotjiort6", String.valueOf(personCount));
                                Log.d("jgiotjiort7", String.valueOf(amount));
                                Log.d("jgiotjiort8",subActivityType);
                                Log.d("jgiotjiort9",vendorName);
            ...
            public void onErrorResponse(VolleyError error) {
                Log.d("tyjyytj", String.valueOf(error));
    ...
    private void loadMore() {
        ...
        String URL = Constant.APIONE+"/slot/getCourseAndMembrShipBookingHistory?type=COR&offset="+String.valueOf(mOffset)+"&limit="+String.valueOf(mLimit)+"&status=nearing";
