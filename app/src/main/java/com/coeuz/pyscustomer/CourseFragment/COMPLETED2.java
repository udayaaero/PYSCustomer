...
public class COMPLETED2 extends Fragment{
    ...
    private void firstLoadData() {
        ...
        String URL = Constant.APIONE+"/slot/getCourseAndMembrShipBookingHistory?type=COR&offset=0&limit=5&status=completed";
                    ...
                    button.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (getFragmentManager() != null) {
                                getFragmentManager()
                                        .beginTransaction()
                                        .detach(COMPLETED2.this)
                                        .attach(COMPLETED2.this)
                                        .commit();
                            }
                        }});
    ...
    private void loadMore() {
        ...
        String URL = Constant.APIONE+"/slot/getCourseAndMembrShipBookingHistory?type=COR&offset="+String.valueOf(mOffset)+"&limit="+String.valueOf(mLimit)+"&status=completed";
