...
import com.coeuz.pyscustomer.ForgotPassordActivity;
import com.coeuz.pyscustomer.MainActivity;
import com.coeuz.pyscustomer.R;
import com.coeuz.pyscustomer.SignUpActivity;
...
public class LoginFrontPage extends AppCompatActivity  implements GoogleApiClient.OnConnectionFailedListener {
    ...
    /*    faceBookLoginbtn.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
        ...
        faceBookLoginbtn.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            @Override
            public void onCancel() {
                Toast.makeText(LoginFrontPage.this, "Login Cancel", Toast.LENGTH_SHORT).show();
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            VolleySingleton.getInstance(LoginFrontPage.this).addToRequestQueue(request);
